...
String APid = "roller";    //Name of access point
String APpw = "roller";           //Hardcoded password for access point
...
char config_name[40] = "blind_roller2";             //WIFI config: Bonjour name of device
char config_rotation[40] = "false"; //WIFI config: Default rotation is CCW
...
long maxPosition = 500000;         //Max position of the blind. Initial value
boolean loadDataSuccess = false;
boolean saveItNow = true;          //If true will store positions to SPIFFS
...
// dirty hack for some reason this is not readable on ESP8266MOD (NodeMCU 1.0)
  json["junk"] = junk;
